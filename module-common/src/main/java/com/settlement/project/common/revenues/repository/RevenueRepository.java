...
import com.settlement.project.common.revenues.dto.DailyRevenueResponseDto;
...
public interface RevenueRepository extends JpaRepository<Revenue, Long> {
    ...
    @Query("SELECT NEW com.settlement.project.common.revenues.dto.DailyRevenueResponseDto(DATE(r.modifiedAt), SUM(r.revenueTotal)) " +
